...
| `TrackingEvents` | [`List<TrackingEventNormal>`](/doc/models/tracking-event-normal.md) | Optional | Tracking events are not populated for registered letters.<br>**Constraints**: *Maximum Items*: `0` | List<TrackingEventNormal> getTrackingEvents() | setTrackingEvents(List<TrackingEventNormal> trackingEvents) |
