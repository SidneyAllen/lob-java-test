...
public class Card {
     ...
     * @param  reorderQuantity  int value for reorderQuantity.
     ...
     * The number of cards to be reordered.
     * @param reorderQuantity Value for int
     */
    ...
    public static class Builder {
        ...
        public Builder(LocalDateTime dateCreated, LocalDateTime dateModified, String object,
                String description, String id, String url, boolean autoReorder, int reorderQuantity,
                String rawUrl, String frontOriginalUrl, String backOriginalUrl,
                List<Thumbnail> thumbnails, int availableQuantity, int pendingQuantity,
                TheStatusOfTheCardEnum status, OrientationEnum orientation, int thresholdAmount) {
            this.dateCreated = dateCreated;
            this.dateModified = dateModified;
            this.object = object;
            this.description = description;
         ...
         * @return Builder
         */
        public Builder reorderQuantity(int reorderQuantity) {
            this.reorderQuantity = reorderQuantity;
            return this;
        }
