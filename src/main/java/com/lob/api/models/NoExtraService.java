...
public class NoExtraService {
    ...
    protected NoExtraService(boolean color, Object to, String carrier, Object from, String id,
            List<TrackingEventNormal> trackingEvents, OptionalNullable<List<Card>> cards,
     ...
     * Setter for Cards.
     * An array of cards associated with a specific letter
     * @param cards Value for List of Card
     */
    @JsonSetter("cards")
    ...
    public String toString() {
        return "NoExtraService [" + "color=" + color + ", to=" + to + ", carrier=" + carrier
                ...
                + ", cards=" + cards + ", returnAddress=" + returnAddress + ", description="
    ...
    public static class Builder {
        ...
        public NoExtraService build() {
            return new NoExtraService(color, to, carrier, from, id, trackingEvents, cards,
                    returnAddress, description, metadata, mergeVariables, sendDate, mailType,
