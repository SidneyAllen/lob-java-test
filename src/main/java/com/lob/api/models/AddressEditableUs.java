...
public class AddressEditableUs {
     ...
     */
    protected AddressEditableUs(String addressLine1, String addressCity, String addressState,
            String addressZip, String name, String company, OptionalNullable<String> addressLine2,
    ...
    public String toString() {
        return "AddressEditableUs [" + "addressLine1=" + addressLine1 + ", addressCity="
                + addressCity + ", addressState=" + addressState + ", addressZip=" + addressZip
                + ", name=" + name + ", company=" + company + ", addressLine2=" + addressLine2
    ...
    public static class Builder {
        ...
        public AddressEditableUs build() {
            return new AddressEditableUs(addressLine1, addressCity, addressState, addressZip, name,
                    company, addressLine2, description, phone, email, addressCountry, metadata);
        }
    }
}
