...
/**
 * This is a model class for CardsOrdersResponse type.
 */
public class CardsOrdersResponse {
     ...
     * @param  data  List of CardOrder value for data.
     */
    public CardsOrdersResponse(
            String object,
            String nextUrl,
     ...
     */
    protected CardsOrdersResponse(String object, OptionalNullable<String> nextUrl,
            OptionalNullable<String> previousUrl, Integer count, List<CardOrder> data) {
        this.object = object;
     ...
     * Getter for Data.
     * List of card orders
     * @return Returns the List of CardOrder
     */
    @JsonGetter("data")
     ...
     * Setter for Data.
     * List of card orders
     * @param data Value for List of CardOrder
     */
    @JsonSetter("data")
    ...
    /**
     * Converts this CardsOrdersResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CardsOrdersResponse [" + "object=" + object + ", nextUrl=" + nextUrl
                + ", previousUrl=" + previousUrl + ", count=" + count + ", data=" + data + "]";
    }

    /**
     * Builds a new {@link CardsOrdersResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CardsOrdersResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CardsOrdersResponse}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<CardOrder> data) {
            this.data = data;
            return this;
        }

        /**
         * Builds a new {@link CardsOrdersResponse} object using the set fields.
         * @return {@link CardsOrdersResponse}
         */
        public CardsOrdersResponse build() {
            return new CardsOrdersResponse(object, nextUrl, previousUrl, count, data);
        }
    }
}
