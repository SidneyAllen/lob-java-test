...
public final class ReverseGeocodeLookupsController extends BaseController {
     ...
     */
    public ReverseGeocodeLookupsController(Configuration config, HttpClient httpClient,
    ...
    public ReverseGeocode reverseGeocodeLookup(
        ...
        HttpRequest request = buildReverseGeocodeLookupRequest(latitude, longitude, size);
        authManagers.get("global").apply(request);

        HttpResponse response = getClientInstance().execute(request, false);
        HttpContext context = new HttpContext(request, response);

        return handleReverseGeocodeLookupResponse(context);
    }
    ...
    public CompletableFuture<ReverseGeocode> reverseGeocodeLookupAsync(
            ...
            final double longitude,
            final Integer size) {
        return makeHttpCallAsync(() -> buildReverseGeocodeLookupRequest(latitude, longitude, size),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsync(request, false)),
            context -> handleReverseGeocodeLookupResponse(context));
    }

    /**
     * Builds the HttpRequest object for reverseGeocodeLookup.
     */
    private HttpRequest buildReverseGeocodeLookupRequest(
            final double latitude,
            final double longitude,
            final Integer size) {
    ...
    /**
     * Processes the response for reverseGeocodeLookup.
     * @return An object of type ReverseGeocode
     */
    private ReverseGeocode handleReverseGeocodeLookupResponse(
