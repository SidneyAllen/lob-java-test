...
public final class PostcardsController extends BaseController {
    ...
    public AllPostcards listPostcards(
        ...
        HttpRequest request = buildListPostcardsRequest(limit, beforeAfter, include, dateCreated,
    ...
    public CompletableFuture<AllPostcards> listPostcardsAsync(
            ...
            final MailTypeEnum mailType,
            final Object sortBy) {
        return makeHttpCallAsync(() -> buildListPostcardsRequest(limit, beforeAfter, include,
