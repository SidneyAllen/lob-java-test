...
public final class BankAccountsController extends BaseController {
    ...
    public BankAccount getBankAccount(
        ...
        HttpRequest request = buildGetBankAccountRequest(bankId);
        authManagers.get("global").apply(request);
     ...
     * @return    Returns the BankAccount response from the API call
     */
    public CompletableFuture<BankAccount> getBankAccountAsync(
            final String bankId) {
        return makeHttpCallAsync(() -> buildGetBankAccountRequest(bankId),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsync(request, false)),
     ...
     * @return An object of type BankAccount
     */
    private BankAccount handleGetBankAccountResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public BankDeletion deleteBankAccount(
            final String bankId) throws ApiException, IOException {
        HttpRequest request = buildDeleteBankAccountRequest(bankId);
        authManagers.get("global").apply(request);

        HttpResponse response = getClientInstance().execute(request, false);
        HttpContext context = new HttpContext(request, response);

        return handleDeleteBankAccountResponse(context);
    }
     ...
     * @return    Returns the BankDeletion response from the API call
     */
    public CompletableFuture<BankDeletion> deleteBankAccountAsync(
            final String bankId) {
        return makeHttpCallAsync(() -> buildDeleteBankAccountRequest(bankId),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsync(request, false)),
     ...
     */
    private BankDeletion handleDeleteBankAccountResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
    ...
    public AllBankAccounts listBankAccounts(
        ...
        HttpRequest request = buildListBankAccountsRequest(limit, beforeAfter, include,
                dateCreated);
        authManagers.get("global").apply(request);
    ...
    public CompletableFuture<AllBankAccounts> listBankAccountsAsync(
        ...
        return makeHttpCallAsync(() -> buildListBankAccountsRequest(limit, beforeAfter, include,
                dateCreated),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsync(request, false)),
    ...
    public BankAccount createBankAccount(
        ...
        HttpRequest request = buildCreateBankAccountRequest(routingNumber, accountNumber,
                accountType, signatory, description, metadata);
        authManagers.get("global").apply(request);
     ...
     * @return    Returns the BankAccount response from the API call
     */
    public CompletableFuture<BankAccount> createBankAccountAsync(
            final String routingNumber,
            final String accountNumber,
            final AccountTypeEnum accountType,
            final String signatory,
        ...
        return makeHttpCallAsync(() -> buildCreateBankAccountRequest(routingNumber, accountNumber,
                accountType, signatory, description, metadata),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsync(request, false)),
     ...
     * @return An object of type BankAccount
     */
    private BankAccount handleCreateBankAccountResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
