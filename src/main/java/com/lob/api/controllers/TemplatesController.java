...
public final class TemplatesController extends BaseController {
    ...
    public AllTemplates listTemplates(
        ...
        HttpRequest request = buildListTemplatesRequest(limit, beforeAfter, include, dateCreated);
        authManagers.get("global").apply(request);
    ...
    public CompletableFuture<AllTemplates> listTemplatesAsync(
        ...
        return makeHttpCallAsync(() -> buildListTemplatesRequest(limit, beforeAfter, include,
                dateCreated),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsync(request, false)),
