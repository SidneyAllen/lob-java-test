...
public final class LettersController extends BaseController {
    ...
    public AllLetters listLetters(
        ...
        HttpRequest request = buildListLettersRequest(limit, beforeAfter, include, dateCreated,
                color, scheduled, sendDate, mailType, sortBy);
        authManagers.get("global").apply(request);
    ...
    public CompletableFuture<AllLetters> listLettersAsync(
            ...
            final MailTypeEnum mailType,
            final Object sortBy) {
        return makeHttpCallAsync(() -> buildListLettersRequest(limit, beforeAfter, include,
                dateCreated, color, scheduled, sendDate, mailType, sortBy),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsync(request, false)),
