...
public final class TemplateVersionsController extends BaseController {
    ...
    public AllTemplateVersions listTemplateVersions(
        ...
        HttpRequest request = buildListTemplateVersionsRequest(tmplId, limit, beforeAfter, include,
                dateCreated);
        authManagers.get("global").apply(request);
    ...
    public CompletableFuture<AllTemplateVersions> listTemplateVersionsAsync(
        ...
        return makeHttpCallAsync(() -> buildListTemplateVersionsRequest(tmplId, limit, beforeAfter,
                include, dateCreated),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsync(request, false)),
