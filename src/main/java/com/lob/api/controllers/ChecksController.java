...
public final class ChecksController extends BaseController {
    ...
    public AllChecks listChecks(
        ...
        HttpRequest request = buildListChecksRequest(limit, beforeAfter, include, dateCreated,
                scheduled, sendDate, mailType, sortBy);
        authManagers.get("global").apply(request);
    ...
    public CompletableFuture<AllChecks> listChecksAsync(
            ...
            final MailTypeEnum mailType,
            final Object sortBy) {
        return makeHttpCallAsync(() -> buildListChecksRequest(limit, beforeAfter, include,
                dateCreated, scheduled, sendDate, mailType, sortBy),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsync(request, false)),
