...
public final class LobClient implements Configuration {
    ...
    private LobClient(Environment environment, HttpClient httpClient,
        ...
        billingGroups = new BillingGroupsController(this, this.httpClient, this.authManagers,
                this.httpCallback);
        cardOrders = new CardOrdersController(this, this.httpClient, this.authManagers,
                this.httpCallback);
        cards = new CardsController(this, this.httpClient, this.authManagers, this.httpCallback);
        ...
        postcards = new PostcardsController(this, this.httpClient, this.authManagers,
                this.httpCallback);
        reverseGeocodeLookups = new ReverseGeocodeLookupsController(this, this.httpClient,
                this.authManagers, this.httpCallback);
